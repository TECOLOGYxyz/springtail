...
def slice(basename, img, imgDim, anno, xs, ys): 
    ...
    for i in ys:
        for j in xs:
            ...
            cv2.imwrite(r'C:\Users\au309263\OneDrive - Aarhus Universitet\Desktop\tempCandida\slicedTrain/{}_{}_{}.{}'.format(basename, suffix, count, frmt), split)
            ...
            slice_labels = []
            slice_labels_path = r'C:\Users\au309263\OneDrive - Aarhus Universitet\Desktop\tempCandida\slicedTrain/{}_{}_{}.txt'.format(basename, suffix, count)
            for box in boxes:
...
path = r'C:\Users\au309263\OneDrive - Aarhus Universitet\Desktop\tempCandida\train'
