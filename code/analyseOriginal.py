...
# pathDet = r'C:\Users\au309263\OneDrive - Aarhus Universitet\Desktop\candida\data\x_20230227\results\original\detect\labels'
# detections = [i for i in os.listdir(pathDet) if i.endswith('.txt')]

# savePath = r'x_20230227Original_DEVEL_boxLevel.txt'

# #savePath = r'x_20230227Original_TESTING_BoxLevel.txt'
