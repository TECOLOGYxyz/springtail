...
We calculated the area of each contour to see if the model accuracy was
dependent on object area.
...
0.3 was used as the IOU threshold for whether bounding boxes overlapped
...
Running inference on image slices with

Table 1 Detection accuracy with the different models. Method (IOU 0.3)
Precision Recall F1 YOLOv5 640 0.46 0.19 0.27 YOLOv5 640 + SAHI (128)
0.60 0.12 0.20 YOLOv5 1280 0.54 0.56 0.55 YOLOv5 1280 + SAHI (128) 0.63
0.41 0.50
...
areas are likely to be human error in the annotation process.
